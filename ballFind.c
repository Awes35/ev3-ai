...
Function Purpose: The purpose of this program is to move about the arena in search of balls, picking up WHITE balls. This is accomplished
                  ...
                  therefore it must be a ball. After checking to see if already carrying a ball, the robot checks if color of ball is WHITE, and decides whether to pick up ball.
